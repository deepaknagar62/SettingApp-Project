...
export default function PrivacyProtectionPassword() {
  ...
  return (
    <>
       <div className='privacy-prtection-conainer'>
        ...
        <div style={{color:'#534d4d' , fontSize:'15px',marginTop:'25px',fontWeight:'300' , marginLeft:'25px'}}>
          ...
          <div className="ppp-container "  >
                ...
                <p style={{display:'flex', justifyItems:'center' ,fontSize:'14px',marginRight:'130px' }}>
                    ...
                    <div style={{display:'flex', position:'absolute', marginLeft:'200px' , fontSize:'25px',marginTop:'-15px',fontWeight:'200'}}> <ToggleBtn name="ppp_privacyProtection"></ToggleBtn></div>
                </p>
            </div>  
            ...
            <span style={{marginLeft:'20px',marginTop:'20px' ,fontSize:'20px',fontWeight:'550'}}>
                Show pattern </span>
            <div style={{marginTop:'20px',display:'flex' ,position:'absolute', marginLeft:'220px',fontSize:'25px',fontWeight:'200'}}> <ToggleBtn  name="ppp_showPattern"></ToggleBtn></div>
            </div>  
            ...
            <div className="ppp-container "  >
                ...
                <p style={{display:'flex', justifyItems:'center' ,fontSize:'14px',marginRight:'30px' }}>
                    ...
                    <div style={{display:'flex', position:'absolute', marginLeft:'200px', fontSize:'25px',marginTop:'-15px',fontWeight:'200'}}> <ToggleBtn  name="ppp_addMI"></ToggleBtn></div>
                </p>
            </div> 
