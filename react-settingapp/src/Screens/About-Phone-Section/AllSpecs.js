      ...
      <>
        ...
        <div className="card1">
           ...
           <div className='inCard1'>
            ...
            <p style={{color:'#534d4d' , fontSize:'15px'}}>  Device model <p style={{marginTop:'0px' , color:'black' , fontWeight:'500'}}>Redmi 8A</p></p>
           </div>
           
           <div className='inCard2'>
            <img src={ramicon} alt="icon" width="35" height="35"></img>
            <p style={{color:'#534d4d' , fontSize:'15px'}}>RAM <p style={{marginTop:'0px' , color:'black' , fontWeight:'500'}}>4.00 GB</p></p>
           </div>
           </div>
           <div>
        ...
        <div className="card2">
         <p style={{ marginTop:'10px' , color:'black' , fontWeight:'500'  }}>  Android version <p style={{color:'#534d4d' , fontSize:'15px',marginTop:'2px',fontWeight:'300'}}>10 QKQ1.191014.001</p></p>
       </div>

       
       <div className='cards'>
                <div className="card4">
                   <p style={{ marginTop:'10px' , color:'black' , fontWeight:'500' } }>Android security </p>
                   <p style={{ marginTop:'80px' ,  fontWeight:'300' } }>2023-09-01</p>
                </div>
            
                <div className="card5">
                <p style={{ marginTop:'10px' , color:'black' , fontWeight:'500'  }}>MIUI version </p>
           ...
           <div className="container" >
            ...
            <div className="container" >
                <span>Baseband version</span> 
                <p>9_GENNS_PACK-2.41274947.5</p>
            </div>

            <div className="container" >
                <span>Kernal version</span> 
