    ...
    <>
     ...
     <Headingtxt headingtxt="SIM card settings"></Headingtxt>
         ...
         <div className='sim-net-container' >
             <span style={{marginLeft:'20px',marginTop:'20px' ,fontSize:'20px',fontWeight:'500'}}> Turn on </span>
         ...
         <div className='sim-net-container' >
             <span style={{marginLeft:'20px',marginTop:'20px' ,fontSize:'20px',fontWeight:'500'}}> Edit SIM card name </span>
             <div style={{marginTop:'20px',display:'flex' , marginLeft:'120px',fontSize:'28px', fontWeight:'300'}}> &#62;</div>
         </div>  

         <div className='sim-net-container' >
             <span style={{marginLeft:'20px',marginTop:'20px' ,fontSize:'20px',fontWeight:'500'}}> Edit SIM card number </span>
        ...
        <div className='sim-net-container' >
            <span style={{marginLeft:'20px',marginTop:'20px' ,fontSize:'20px',fontWeight:'500'}}> Preferred network type </span>
            <div style={{marginTop:'20px',display:'flex' , marginLeft:'70px',fontSize:'28px', fontWeight:'300'}}> &#62;</div>
         </div>   

         <div className='sim-net-container' >
             <span style={{marginLeft:'20px',marginTop:'20px' ,fontSize:'20px',fontWeight:'500'}}> Mobile networks </span>
         ...
         <div className="sim-net-settings " style={{marginTop:'30px',marginLeft:'20px'}}>
            <span style={{fontSize:"18px" ,fontWeight:'500'}}>Use VoLTE</span> 
           ...
           <div className="sim-net-settings " style={{marginTop:'30px',marginLeft:'20px'}}>
            <span style={{fontSize:"18px" ,fontWeight:'500'}}>Make calls using Wi-Fi</span> 
            <p style={{display:'flex', justifyItems:'center' ,fontSize:'14px',marginRight:'39px',marginTop:'0px' }}>
